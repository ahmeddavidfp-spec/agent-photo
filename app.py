...
def init_db():
    """Initialise et met à jour la structure de la base de données."""
...
def generate_ai_caption(image_url, galerie_nom):
    ...
    STRATÉGIE : 1. Crochet percutant. 2. Vocabulaire riche. 3. 2-3 phrases claires.
    STRUCTURE : Titre / Analyse / Lien: {display_link} / Hashtags {extra_tag}."""
    ...
    clean = response.choices[0].message.content.replace("**", "").replace("### ", "")
    return clean[:495]
